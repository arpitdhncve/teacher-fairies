import { AbortDuoProjectAction, Streaming, createAgentActionInfo } from '@tldraw/fairy-shared'
import { uniqueId } from 'tldraw'
import { AgentHelpers } from '../fairy-agent/AgentHelpers'
import { FairyAgent } from '../fairy-agent/FairyAgent'
import { AgentActionUtil } from './AgentActionUtil'

export class AbortDuoProjectActionUtil extends AgentActionUtil<AbortDuoProjectAction> {
	static override type = 'abort-duo-project' as const

	override getInfo(action: Streaming<AbortDuoProjectAction>) {
	...
	override applyAction(action: Streaming<AbortDuoProjectAction>, _helpers: AgentHelpers) {
